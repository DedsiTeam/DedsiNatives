...
export default function MenuManagement() {
  ...
  return <main className={styles.page}>
    <Card className={styles.headerCard}><div className={styles.toolbar}><Input className={styles.search} allowClear prefix={<SearchOutlined />} placeholder="按菜单名称搜索" value={draftName} onChange={(event) => setDraftName(event.target.value)} onPressEnter={submitSearch} /><Space wrap><Button type="primary" onClick={submitSearch}>查询</Button><Button onClick={resetSearch}>重置</Button><Button type="primary" className="create-primary-button" icon={<PlusOutlined />} onClick={openCreate}>新增菜单</Button></Space></div></Card>
